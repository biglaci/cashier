...
import 'spk_knpr_lastguest.dart';

import 'package:flutter/widgets.dart';

import '../idempiere_rest/idempiere_client.dart';

class MspkKnprLastGuest extends ChangeNotifier {
  MspkKnprLastGuest({
  ...
  Future getData() async {
    ...
    var mJson = await IdempiereClient().getJson(
        ...
        showsql: true);
    // now we have a json...
    this.data = SpkKnprLastGuest.fromJson(mJson);
